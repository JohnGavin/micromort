...
## 6. Demographic What-If: How Age Reshuffles the Top 10
...
anaes_default <- whatif[whatif$activity == "General anaesthesia (elective)", "default_mm"]
anaes_aged <- whatif[whatif$activity == "General anaesthesia (elective)", "aged_mm"]
bath_default <- whatif[whatif$activity == "Taking a bath (age-conditioned)", "default_mm"]
bath_aged <- whatif[whatif$activity == "Taking a bath (age-conditioned)", "aged_mm"]
```
...
## 7. Implications for the Micromort Package
