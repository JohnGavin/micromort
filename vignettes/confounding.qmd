...
show_target("vig_confounding_disease_by_country",
  caption = "Daily micromorts by disease cause and country (IHME GBD 2023). Cardiovascular disease (CVD) leads everywhere; diarrheal disease shows 68x UK-India gap driven by sanitation infrastructure. Source: atomic_risks() Parts 11a-11d.")
```
...
- **[Cardiovascular disease (CVD)](https://www.who.int/health-topics/cardiovascular-diseases)** is the leading killer everywhere, at `r uk_cvd` mm/day in the UK and `r in_cvd` mm/day in India (`r cvd_ratio`x ratio). For context, a single skydive is 8 mm — less than 3 days of background <abbr title="Cardiovascular disease">CVD</abbr> risk in India.
