...
This is a mathematical constant ($1/2^{20}$), not an estimate. It requires no denominator, no data source, and no geographic adjustment. If you can imagine the surprise of 20 consecutive heads, you can feel the scale of 1 micromort.
