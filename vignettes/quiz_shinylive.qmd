...
function renderQR(containerId, size) {
  ...
  qr.addData(url);
  qr.make();
  el.innerHTML = '<div style=\"display:flex;align-items:center;gap:12px;margin-top:12px;padding:8px 0;\">' +
    qr.createImgTag(size || 3) +
    '<span style=\"font-size:0.85rem;color:#6c757d;word-break:break-all;\">' + url + '</span></div>';
}
...
"Commercial fishing (per work day)","American football",20,"Sport",0,"per game",3,"Occupation",0,"per day",6.66666666666667,"easy","a","Contact sport risk from traumatic injury including spinal and head trauma.","https://en.wikipedia.org/wiki/American_football","Extreme weather, vessel sinking, and deck machinery make fishing one of the deadliest occupations.","https://www.bls.gov/iif/fatal-injuries-tables.htm"
"Commercial fishing (per work day)","COVID-19 unvaccinated (all ages)",20,"COVID-19",0,"11 weeks (2022)",3,"Occupation",0,"per day",6.66666666666667,"easy","a","Population-average COVID-19 mortality risk for unvaccinated individuals in 2022.","https://www.cdc.gov/mmwr/volumes/72/wr/mm7206a3.htm","Extreme weather, vessel sinking, and deck machinery make fishing one of the deadliest occupations.","https://www.bls.gov/iif/fatal-injuries-tables.htm"
...
"Logging (per work day)","Snake bite (US, with antivenom)",0.5,"Wildlife",100,"per bite",3.3,"Occupation",0,"per day",6.6,"easy","b","Snake bite fatality risk in the US where antivenom is readily available.","https://en.wikipedia.org/wiki/Snakebite","Highest US occupational fatality rate; hazards include falling trees, chainsaw injuries, and terrain.","https://www.bls.gov/iif/fatal-injuries-tables.htm"
"Logging (per work day)","Drinking a glass of wine (daily, chronic risk)",0.5,"Daily Life",0,"per day (chronic)",3.3,"Occupation",0,"per day",6.6,"easy","b","Wikipedia's 0.5 mm figure mixes chronic effects (cancer, liver disease from daily drinking) with acute risk. Actual acute risk from a single glass is <0.05 mm. See chronic_risks() for microlife-based alcohol data.","https://en.wikipedia.org/wiki/Alcohol_(drug)","Highest US occupational fatality rate; hazards include falling trees, chainsaw injuries, and terrain.","https://www.bls.gov/iif/fatal-injuries-tables.htm"
...
"Commuting by bicycle (30 min)","COVID-19 monovalent vaccine (age 18-49)",0.2,"COVID-19",0,"11 weeks (2022)",0.12,"Travel",0,"per trip",1.66666666666667,"hard","a","Young adult monovalent-vaccinated COVID-19 mortality was very low.","https://www.cdc.gov/mmwr/volumes/72/wr/mm7206a3.htm","0.12 mm per trip (range 0.09-0.14). Based on Cycling UK 2024: 9-11M trips per fatality. Cross-checked with DfT deaths / NTS distance. Previous Wikipedia estimate of 0.5 mm was ~4x too high.","https://www.cyclinguk.org/statistics"
