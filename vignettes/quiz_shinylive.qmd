...
quiz_css <- "
  ...
  .detail-table th, .detail-table td { overflow: hidden; text-overflow: ellipsis; }
  .detail-table th:nth-child(1), .detail-table td:nth-child(1) { width: 4%; }
  .detail-table th:nth-child(2), .detail-table td:nth-child(2) { width: 18%; }
  .detail-table th:nth-child(3), .detail-table td:nth-child(3) { width: 6%; }
  .detail-table th:nth-child(4), .detail-table td:nth-child(4) { width: 18%; }
  .detail-table th:nth-child(5), .detail-table td:nth-child(5) { width: 6%; }
  .detail-table th:nth-child(6), .detail-table td:nth-child(6) { width: 18%; }
  .detail-table th:nth-child(7), .detail-table td:nth-child(7) { width: 18%; }
  .detail-table th:nth-child(8), .detail-table td:nth-child(8) { width: 6%; }
  .detail-table td { white-space: normal; word-wrap: break-word; }
"
...
instructions_ui <- function() {
  ...
  tagList(
    h4("Hints", class = "text-center mb-0"),
    card(
      card_body(
        tags$ul(class = "mb-1",
