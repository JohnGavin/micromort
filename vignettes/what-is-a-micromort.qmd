...
show_target("vig_whatis_mundane_table",
  caption = "Seven mundane activities ranked by micromorts (mm). Ratio vs coffee = mm / 0.01 mm (cup of coffee). Values from common_risks() except wine (Wikipedia/Spiegelhalter source, chronic daily risk). Source: micromort package.")
```
