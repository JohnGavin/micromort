...
```{r quiz-intro-sentence, results='asis', echo=FALSE}
cat(safe_tar_read("vig_whatis_quiz_intro_sentence") %||% "")
```
But how good is your intuition? Three quizzes, three formats:
...
#| echo: false
#| results: asis
bi <- safe_tar_read("vig_build_info")
