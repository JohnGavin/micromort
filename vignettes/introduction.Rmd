...
The lesson: **always ask "conditional on what?"** before comparing micromort values across populations or activities.
...
Risks that fail criterion 2 but pass the others may still appear with `period = "per year"` as a background population rate, clearly labelled as such. See `risk_data_sources()` for full provenance of each entry.
