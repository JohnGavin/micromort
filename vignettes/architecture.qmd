...
Data pipeline flowchart showing five stages of risk data processing with target counts per stage.
:::
...
Function hierarchy grouping all exported functions by category.
:::
...
Decision tree showing which function to start with based on your analysis goal.
:::
...
Nine-step developer workflow including RED-GREEN TDD cycle at steps 4--5.
:::
...
Auto-generated dependency graph of the full targets pipeline showing all targets and their connections.
:::
