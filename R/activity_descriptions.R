...
activity_descriptions <- function() {
  tibble::tribble(
    ...
    # Country-level disease mortality (OWID/GBD 2023)
    "Daily CVD mortality risk (UK)",
    "Age-standardised daily cardiovascular disease mortality in the UK (IHME GBD 2023). Includes ischaemic heart disease, stroke, and other CVD.",
    "https://ourworldindata.org/grapher/cardiovascular-disease-death-rate",
    "Daily CVD mortality risk (US)",
    "Age-standardised daily cardiovascular disease mortality in the US (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cardiovascular-disease-death-rate",
    "Daily CVD mortality risk (Japan)",
    "Age-standardised daily cardiovascular disease mortality in Japan (IHME GBD 2023). Japan has among the lowest CVD rates in high-income countries.",
    "https://ourworldindata.org/grapher/cardiovascular-disease-death-rate",
    "Daily CVD mortality risk (India)",
    "Age-standardised daily cardiovascular disease mortality in India (IHME GBD 2023). India's CVD rate is roughly double that of high-income countries.",
    "https://ourworldindata.org/grapher/cardiovascular-disease-death-rate",
    "Daily CVD mortality risk (Nigeria)",
    "Age-standardised daily cardiovascular disease mortality in Nigeria (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cardiovascular-disease-death-rate",
    "Daily CVD mortality risk (Brazil)",
    "Age-standardised daily cardiovascular disease mortality in Brazil (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cardiovascular-disease-death-rate",

    "Daily cancer mortality risk (UK)",
    "Age-standardised daily cancer (all neoplasms) mortality in the UK (IHME GBD 2023). UK has one of the highest cancer death rates globally.",
    "https://ourworldindata.org/grapher/cancer-death-rates",
    "Daily cancer mortality risk (US)",
    "Age-standardised daily cancer mortality in the US (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cancer-death-rates",
    "Daily cancer mortality risk (Japan)",
    "Age-standardised daily cancer mortality in Japan (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cancer-death-rates",
    "Daily cancer mortality risk (India)",
    "Age-standardised daily cancer mortality in India (IHME GBD 2023). Lower rate than high-income countries, partly due to different risk factor prevalence.",
    "https://ourworldindata.org/grapher/cancer-death-rates",
    "Daily cancer mortality risk (Nigeria)",
    "Age-standardised daily cancer mortality in Nigeria (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cancer-death-rates",
    "Daily cancer mortality risk (Brazil)",
    "Age-standardised daily cancer mortality in Brazil (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/cancer-death-rates",

    "Daily LRI mortality risk (UK)",
    "Age-standardised daily lower respiratory infection (pneumonia) mortality in the UK (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized",
    "Daily LRI mortality risk (US)",
    "Age-standardised daily lower respiratory infection mortality in the US (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized",
    "Daily LRI mortality risk (Japan)",
    "Age-standardised daily lower respiratory infection mortality in Japan (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized",
    "Daily LRI mortality risk (India)",
    "Age-standardised daily lower respiratory infection mortality in India (IHME GBD 2023). LRI is a leading cause of death in low-income settings.",
    "https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized",
    "Daily LRI mortality risk (Nigeria)",
    "Age-standardised daily lower respiratory infection mortality in Nigeria (IHME GBD 2023). Among the highest rates globally.",
    "https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized",
    "Daily LRI mortality risk (Brazil)",
    "Age-standardised daily lower respiratory infection mortality in Brazil (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/pneumonia-death-rates-age-standardized",

    "Daily diarrheal mortality risk (UK)",
    "Age-standardised daily diarrheal disease mortality in the UK (IHME GBD 2023). Effectively zero in high-income countries with clean water.",
    "https://ourworldindata.org/grapher/diarrheal-disease-death-rates",
    "Daily diarrheal mortality risk (US)",
    "Age-standardised daily diarrheal disease mortality in the US (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/diarrheal-disease-death-rates",
    "Daily diarrheal mortality risk (Japan)",
    "Age-standardised daily diarrheal disease mortality in Japan (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/diarrheal-disease-death-rates",
    "Daily diarrheal mortality risk (India)",
    "Age-standardised daily diarrheal disease mortality in India (IHME GBD 2023). Reflects gaps in sanitation and clean water access.",
    "https://ourworldindata.org/grapher/diarrheal-disease-death-rates",
    "Daily diarrheal mortality risk (Nigeria)",
    "Age-standardised daily diarrheal disease mortality in Nigeria (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/diarrheal-disease-death-rates",
    "Daily diarrheal mortality risk (Brazil)",
    "Age-standardised daily diarrheal disease mortality in Brazil (IHME GBD 2023).",
    "https://ourworldindata.org/grapher/diarrheal-disease-death-rates",

    # Risk-factor-attributed mortality (OWID/GBD 2019)
    "Daily smoking-attributed mortality (UK)",
    "Deaths attributable to tobacco smoking in the UK (IHME GBD 2019). Includes lung cancer, COPD, and CVD caused by smoking.",
    "https://ourworldindata.org/grapher/death-rate-smoking",
    "Daily smoking-attributed mortality (US)",
    "Deaths attributable to tobacco smoking in the US (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/death-rate-smoking",
    "Daily smoking-attributed mortality (Japan)",
    "Deaths attributable to tobacco smoking in Japan (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/death-rate-smoking",
    "Daily smoking-attributed mortality (India)",
    "Deaths attributable to tobacco smoking in India (IHME GBD 2019). Includes bidi and chewing tobacco.",
    "https://ourworldindata.org/grapher/death-rate-smoking",
    "Daily smoking-attributed mortality (Nigeria)",
    "Deaths attributable to tobacco smoking in Nigeria (IHME GBD 2019). Low prevalence drives low attribution.",
    "https://ourworldindata.org/grapher/death-rate-smoking",
    "Daily smoking-attributed mortality (Brazil)",
    "Deaths attributable to tobacco smoking in Brazil (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/death-rate-smoking",

    "Daily air pollution mortality (UK)",
    "Deaths attributable to ambient and household air pollution in the UK (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/outdoor-air-pollution-death-rate",
    "Daily air pollution mortality (US)",
    "Deaths attributable to air pollution in the US (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/outdoor-air-pollution-death-rate",
    "Daily air pollution mortality (Japan)",
    "Deaths attributable to air pollution in Japan (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/outdoor-air-pollution-death-rate",
    "Daily air pollution mortality (India)",
    "Deaths attributable to air pollution in India (IHME GBD 2019). India has among the highest pollution-attributed death rates globally.",
    "https://ourworldindata.org/grapher/outdoor-air-pollution-death-rate",
    "Daily air pollution mortality (Nigeria)",
    "Deaths attributable to air pollution in Nigeria (IHME GBD 2019). Dominated by household air pollution from solid fuel use.",
    "https://ourworldindata.org/grapher/outdoor-air-pollution-death-rate",
    "Daily air pollution mortality (Brazil)",
    "Deaths attributable to air pollution in Brazil (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/outdoor-air-pollution-death-rate",

    "Daily obesity-attributed mortality (UK)",
    "Deaths attributable to high body mass index in the UK (IHME GBD 2019). Includes CVD, diabetes, and cancer attributed to obesity.",
    "https://ourworldindata.org/grapher/death-rate-from-obesity",
    "Daily obesity-attributed mortality (US)",
    "Deaths attributable to high BMI in the US (IHME GBD 2019). US has among the highest obesity-attributed death rates in high-income countries.",
    "https://ourworldindata.org/grapher/death-rate-from-obesity",
    "Daily obesity-attributed mortality (Japan)",
    "Deaths attributable to high BMI in Japan (IHME GBD 2019). Low rate reflects low obesity prevalence.",
    "https://ourworldindata.org/grapher/death-rate-from-obesity",
    "Daily obesity-attributed mortality (India)",
    "Deaths attributable to high BMI in India (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/death-rate-from-obesity",
    "Daily obesity-attributed mortality (Nigeria)",
    "Deaths attributable to high BMI in Nigeria (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/death-rate-from-obesity",
    "Daily obesity-attributed mortality (Brazil)",
    "Deaths attributable to high BMI in Brazil (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/death-rate-from-obesity",

    "Daily alcohol-attributed mortality (UK)",
    "Deaths attributable to alcohol use in the UK (IHME GBD 2019). Includes liver cirrhosis, cancer, and injuries.",
    "https://ourworldindata.org/grapher/alcohol-death-rate",
    "Daily alcohol-attributed mortality (US)",
    "Deaths attributable to alcohol use in the US (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/alcohol-death-rate",
    "Daily alcohol-attributed mortality (Japan)",
    "Deaths attributable to alcohol use in Japan (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/alcohol-death-rate",
    "Daily alcohol-attributed mortality (India)",
    "Deaths attributable to alcohol use in India (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/alcohol-death-rate",
    "Daily alcohol-attributed mortality (Nigeria)",
    "Deaths attributable to alcohol use in Nigeria (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/alcohol-death-rate",
    "Daily alcohol-attributed mortality (Brazil)",
    "Deaths attributable to alcohol use in Brazil (IHME GBD 2019).",
    "https://ourworldindata.org/grapher/alcohol-death-rate"
  )
}
