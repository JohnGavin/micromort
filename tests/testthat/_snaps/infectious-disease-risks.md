# invalid year raises informative error
    ...
    Condition
      Error in `infectious_disease_risks()`:
...
# unknown ISO-3 raises informative error
    ...
    Condition
      ...
      i Available codes: "ARG", "AUS", "BGD", "BRA", "CAN", "CHN", "DEU", "ESP", "ETH", "FRA", "GBR", "IDN", "IND", "ITA", "JPN", "KOR", "MEX", "NGA", ..., "USA", and "ZAF".
      i Use `country = "all"` to return all available countries.

# infectious_disease_risks() GBR structure snapshot
