...
#>  8 Base jumping (per jump)                 Parachuting from fixed obje… https:/…
...
#>   activity             description                                      help_url
#>   <chr>                <chr>                                            <chr>   
#> 1 Skydiving (per jump) Risk from parachute malfunction, mid-air collis… https:/…
#> 2 Skydiving (US)       US skydiving fatality rate based on USPA incide… https:/…
#> 3 Skydiving (UK)       UK skydiving fatality rate based on British Par… https:/…
```
